...
LOCAL_REQUIRED_MODULES := privapp_whitelist_com.google.android.settings.intelligence.xml
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := privapp_whitelist_com.google.android.settings.intelligence.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/permissions
LOCAL_PRODUCT_MODULE := true
LOCAL_SRC_FILES := SettingsIntelligenceGooglePrebuilt/privapp_whitelist_com.google.android.settings.intelligence.xml
include $(BUILD_PREBUILT)
